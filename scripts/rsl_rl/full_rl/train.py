...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    ...
    # Keep RSL-RL ``experiment_name`` aligned with the log folder (unless ``--experiment_name`` already set it).
    ...
    # ViTacLab direct tasks: spawn third-person / tactile / tiled cameras only when rendering is enabled.
