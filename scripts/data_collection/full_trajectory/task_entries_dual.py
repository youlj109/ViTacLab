...
_TASK_PRESETS: dict[str, dict[str, str]] = {
    ...
    "bi_blind_bin_drop": {
        "env": "ViTacLab.tasks.direct.difficult_dexhand.bi_blind_bin_drop.bi_blind_bin_drop_env:UR10eDualShadowHandBiBlindBinDropEnv",
        "cfg": "ViTacLab.tasks.direct.difficult_dexhand.bi_blind_bin_drop.bi_blind_bin_drop_env_cfg:UR10eDualShadowHandBiBlindBinDropEnvCfg",
    },
    "bi_blind_inhand": {
        "env": "ViTacLab.tasks.direct.difficult_dexhand.bi_blind_inhand.bi_blind_inhand_env:UR10eDualShadowHandBiBlindInhandEnv",
        "cfg": "ViTacLab.tasks.direct.difficult_dexhand.bi_blind_inhand.bi_blind_inhand_env_cfg:UR10eDualShadowHandBiBlindInhandEnvCfg",
    },
    "bi_blind_peg": {
        "env": "ViTacLab.tasks.direct.medium_dexhand.bi_peg.bi_peg_env:UR10eDualShadowHandBiPegEnv",
        "cfg": "ViTacLab.tasks.direct.difficult_dexhand.bi_blind_peg.bi_blind_peg_env_cfg:UR10eDualShadowHandBiBlindPegEnvCfg",
    },
    "hand_over": {
    ...
    "bi_stab": {
        "env": "ViTacLab.tasks.direct.simple_dexhand.bi_stab.bi_stab_env:UR10eDualShadowHandBiStabEnv",
        "cfg": "ViTacLab.tasks.direct.simple_dexhand.bi_stab.bi_stab_env_cfg:UR10eDualShadowHandBiStabEnvCfg",
    },
    "dual_pour": {
        "env": "ViTacLab.tasks.direct.simple_dexhand.dual_pour_water.ur10e_dual_shadowhand_pour_env:UR10eDualShadowHandPourEnv",
        "cfg": "ViTacLab.tasks.direct.simple_dexhand.dual_pour_water.ur10e_dual_shadowhand_pour_env_cfg:UR10eDualShadowHandPourEnvCfg",
    },
    "unscrew": {
...
_TASK_GYM_ID_ALIASES: dict[str, str] = {
    ...
    "Isaac-UR10e-Dual-Shadow-Hand-BiBlindBinDrop-Direct-v0": "bi_blind_bin_drop",
    "Isaac-UR10e-Dual-Shadow-Hand-BiBlindInhand-Direct-v0": "bi_blind_inhand",
    "Isaac-UR10e-Dual-Shadow-Hand-BiBlindPeg-Direct-v0": "bi_blind_peg",
    "Isaac-UR10e-Dual-Shadow-Hand-Over-Direct-v0": "hand_over",
    "Isaac-UR10e-Dual-Shadow-Hand-BiPeg-Direct-v0": "bi_peg",
    "Isaac-UR10e-Dual-Shadow-Hand-BiStab-Direct-v0": "bi_stab",
    "Isaac-UR10e-Dual-Shadow-Hand-PourDeformable-Direct-v0": "dual_pour",
